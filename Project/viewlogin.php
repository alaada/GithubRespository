            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse"><!--navigation bar buttons-->
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#contactdialog">Contact</a></li><!--Avab contact vorm-->
                        <li><a href="#" data-toggle="modal" data-target="#logdialog">Log in</a></li><!--Avab login Form-->
                        <li><a href="#" data-toggle="modal" data-target="#regdialog">Sign in</a></li><!--Avab reg Form-->
                        <li class="navbar text-center"> <?php foreach (message_list() as $message): ?> <!--Message viewer-->
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item"><!--Slide3-->
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h3>slide3</h3>
                    <p>Ei ole fantaasiat</p>
                    <a class="btn btn-lg btn-primary" href="#" role="button">Nupp :)</a>
                </div>
            </div>
        </div><!--/Slide3-->
    </div>
...
<div class="container">
    ...
    <div class="container-fluid">
        <div class="row text-justify">
            We glad to see you on our page. Mina ei tea mis voiks siin kirjutada
        </div>
    </div>
</div>
...
<div class="modal" id="logdialog"><!--Login form-->
...
<div class="modal in" id="regdialog"><!--regform-->
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
